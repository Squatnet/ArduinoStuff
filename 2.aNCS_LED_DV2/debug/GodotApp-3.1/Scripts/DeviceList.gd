...
func _list_type_0_btn_pressed(arg):
	...
	newPg.setup([0,arg])
	get_parent().get_parent().get_node("ContentArea2").add_child(newPg)
	get_parent().get_parent().get_node("ContentArea2").rect_position = Vector2(-10,0)
	pass
func _list_type_1_btn_pressed(arg):
	...
	newPg.setup([1,arg])
	get_parent().get_parent().get_node("ContentArea2").add_child(newPg)
	get_parent().get_parent().get_node("ContentArea2").rect_position = Vector2(0,0)
	pass
