...
CRGB tst[256];
const unsigned char TxtDemo[] = {  EFFECT_FRAME_RATE "\x04" EFFECT_HSV_AV "\x00\xff\xff\x40\x00\xff" EFFECT_SCROLL_LEFT "   STRONG   " 
                                  EFFECT_HSV_AV "\x12\x23\xff\xff\x00\x00" EFFECT_SCROLL_RIGHT "   ELBSTS   " //cba to type backwards now
};
