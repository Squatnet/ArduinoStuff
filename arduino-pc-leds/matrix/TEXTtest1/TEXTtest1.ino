...
void loop() {
  ...
  if (readString.length() >0) {
    ...
    if (readString == "99"){ gCurrentPatternNumber = random(8); }
    else {gCurrentPatternNumber = readString.toInt();}
    readString="";
  }
   ...
   EVERY_N_SECONDS( 10 ) { Serial.println("Still Alive"); } // change patterns periodically
